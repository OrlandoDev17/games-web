  ...
  return (
    <div className="app">
      <header className="navbar">
          ...
          <a href="#" className="nav-link">
            ...
            >
              <path
                ...
                stroke-linejoin="round"
                stroke-width="1.5"
                d="M3.25 9.75c3 3.5 4.75 4.5 4.75 4.5s1.75-1 4.75-4.5s1-7-1.5-7s-3.25 3-3.25 3s-.75-3-3.25-3s-4.5 3.5-1.5 7z"
              />
            </svg>
            <span>Favoritos</span>
          </a>
        ...
        <button className="neu-button">Registrate</button>
      </header>
