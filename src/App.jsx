  ...
  return (
    <div>
      ...
      <div>
        ...
        <div>
          <button className="boton-home">Explorar Catalogo</button><button className="boton-home">Crear Cuenta  </button>
        </div>
        </div>
      </div>
      <div className="bajo-boton-home">
        <div className="imagenes-container">
          <div className="imagen-item">
            ...
            <p>Gran cantidad de juegos disponobles</p>
          </div>
          <div className="imagen-item">
          ...
          <div className="imagen-item">
            ...
            <p>Con los titulos mejor valorados</p>
          </div>
        </div>
        <h2 className="titulo-adicional">Resgístrate para comenzar con esta experiencia</h2>
      </div>
    </div>
  );
}
